...
import { ChangeStatus } from '@/data/services/brother/productlist-service'; // Import the ChangeStatus function
import { Status } from '@/data/services/enum/enum'; // Assuming Status is an enum with 'Active' and 'Inactive'
