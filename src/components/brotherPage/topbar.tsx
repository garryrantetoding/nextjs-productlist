...
//   return (
//     <div className={`p-4 max-h-[${topbarHeight}px] bg-white w-full fixed top-0 left-0 border-b-2 border-gray-300 z-45`}>
...
import { menuItems } from './constantSidebar';
...
export default function Topbar() {
  ...
  // Find the current menu item based on the current route
  const currentItem = menuItems.find(item => item.path === pathname);

  return (
    <header className="w-full bg-white border-b-2 border-neutral-200 p-4 shadow">

        <div className="flex justify-between items-center w-full"> {/* Flexbox layout */}
        <div className="flex justify-start items-center gap-4"> {/* Flexbox layout */}

        <h2 className="text-xl font-semibold">
            {currentItem ? currentItem.icon("#5293FF") : ''}
          </h2>
          <h2 className="text-xl font-semibold">
